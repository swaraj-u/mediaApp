...
function App() {
  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route path="/">
        <Route path="login" element={isLoggedIn ? <Navigate to={"/dashboard/"+`${isLoggedIn}`} replace /> : <Login/>}></Route>
  ...
  return (
    <UserContext.Provider value={{ isLoggedIn, setIsLoggedIn, addRoom, setAddRoom}}>
     <ChakraProvider>
